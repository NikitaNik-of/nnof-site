...
const Maintenance = () => {
  return (
    <div className='justify-center flex bg-gray-50/30 dark:bg-gray-900/30 backdrop-blur'>
      <div className='z-30 flex flex-col justify-center text-center items-center h-screen w-11/12 lg:w-4/5'>
        ...
        <div className="transition-all text-xl md:text-3xl md:my-2 flex space-x-2 flex-wrap justify-center">
          ...
          <SlideUp pauseFor={700}>{'скоро '}</SlideUp>
