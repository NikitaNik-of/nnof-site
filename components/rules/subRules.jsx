...
const SubRules = ({bodyname, ...props}) => {
  return (
    <div className='bg-red-300/30 dark:bg-red-600/10 flex flex-col place-content-center items-center mt-12 mb-8 py-12 -skew-y-3'>
      <div className='m-2 skew-y-3'><Image src={pin} width={65} height={65} placeholder='blur' unoptimized/></div>
      <div className="py-2 px-4 w-4/5 lg:w-auto text-center text-sm lg:text-base skew-y-3">
